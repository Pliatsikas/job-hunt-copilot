import { BarChart3, Briefcase, FileText, Inbox, Sun, UserRound, type LucideIcon } from "lucide-react";
import type { MessageKey } from "@/lib/i18n/t";

export type NavItem = { href: string; labelKey: MessageKey; icon: LucideIcon };

/**
 * Six destinations. Usage left the menu in T06: it is a check, not a place
